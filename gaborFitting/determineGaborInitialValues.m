function [ fittedTheta, fittedLamda, horizontalShift, verticalShift ] = determineGaborInitialValues(patch)
...
%% determine position
[sorted, sortIndices] = sort(patchMatrix(:));
...
fittedLamda = 1/totalLength*size(patchMatrix,1)*2;
